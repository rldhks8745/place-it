...
public class NicknameActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit.setText( getIntent.getStringExtra( "NIckname" ) );
        ...
        btChange.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                try {
                    new Data().change_nickname( str, loginId );
                    Toast.makeText( NicknameActivity.this, "상태메세지 변경 완료", Toast.LENGTH_SHORT);
                } catch (JSONException e) {
                    e.printStackTrace();
                    Toast.makeText( NicknameActivity.this, "상태메세지 변경 실패", Toast.LENGTH_SHORT);
                }
